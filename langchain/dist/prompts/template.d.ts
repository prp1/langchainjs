...
export declare const parseTemplate: (
  template: string,
  templateFormat: TemplateFormat
) => ParsedFStringNode[];
export declare const checkValidTemplate: (
  template: string,
  templateFormat: TemplateFormat,
