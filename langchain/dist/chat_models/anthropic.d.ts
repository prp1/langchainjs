 ...
 *
 */
export declare class ChatAnthropic
  ...
  implements AnthropicInput
{
  ...
  _identifyingParams(): {
    metadata?:
      | CompletionCreateParams.CompletionRequestNonStreaming.Metadata
      | CompletionCreateParams.CompletionRequestStreaming.Metadata
      | undefined;
