...
export declare class FunctionCallStructuredOutputParser<
 ...
 */
export declare function createStructuredOutputChain<
  T extends z.AnyZodObject = z.AnyZodObject
>(input: StructuredOutputChainInput): LLMChain<any, ChatOpenAI>;
export declare function createStructuredOutputChainFromZod<
  T extends z.AnyZodObject
>(
  zodSchema: T,
