...
export declare function parseCallbackConfigArg(
...
export declare class CallbackManagerForRetrieverRun
...
export declare class CallbackManagerForLLMRun
  extends BaseRunManager
  implements BaseCallbackManagerMethods
{
...
export declare class CallbackManagerForChainRun
  extends BaseRunManager
  implements BaseCallbackManagerMethods
{
  getChild(tag?: string): CallbackManager;
...
export declare class CallbackManagerForToolRun
  extends BaseRunManager
  implements BaseCallbackManagerMethods
{
  getChild(tag?: string): CallbackManager;
...
export declare function traceAsGroup<T, A extends any[]>(
  groupOptions: {
    name: string;
