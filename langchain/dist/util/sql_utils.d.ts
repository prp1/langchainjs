...
export declare const verifyListTablesExistInDatabase: (
  tablesFromDatabase: Array<SqlTable>,
  listTables: Array<string>,
  errorPrefixMsg: string
) => void;
export declare const verifyIncludeTablesExistInDatabase: (
  tablesFromDatabase: Array<SqlTable>,
  includeTables: Array<string>
) => void;
export declare const verifyIgnoreTablesExistInDatabase: (
  tablesFromDatabase: Array<SqlTable>,
  ignoreTables: Array<string>
) => void;
export declare const getTableAndColumnsName: (
  appDataSource: DataSource
) => Promise<Array<SqlTable>>;
export declare const generateTableInfoFromTables: (
  tables: Array<SqlTable> | undefined,
  appDataSource: DataSource,
  nbSampleRow: number
) => Promise<string>;
export declare const getPromptTemplateFromDataSource: (
  appDataSource: DataSource
) => PromptTemplate;
