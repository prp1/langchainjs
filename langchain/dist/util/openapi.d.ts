...
export declare class OpenAPISpec {
  ...
  getRootReferencedSchema(
    ref: OpenAPIV3_1.ReferenceObject
  ): OpenAPIV3.ParameterObject;
  getReferencedRequestBody(
    ref: OpenAPIV3_1.ReferenceObject
  ): OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.RequestBodyObject;
  getRootReferencedRequestBody(
    ref: OpenAPIV3_1.ReferenceObject
    ...
    | ({
      ...
      > & {
          ...
          callbacks?:
            | Record<
                string,
                OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.CallbackObject
              >
            | undefined;
          servers?: OpenAPIV3_1.ServerObject[] | undefined;
        })
