...
> extends BaseOutputParser<z.infer<T>> {
  ...
  static fromZodSchema<T extends z.ZodTypeAny>(
    schema: T
...
export declare class JsonMarkdownStructuredOutputParser<
  T extends z.ZodTypeAny
...
export declare abstract class AsymmetricStructuredOutputParser<
  T extends z.ZodTypeAny,
  Y = unknown
