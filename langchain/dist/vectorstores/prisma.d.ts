...
>;
export declare class PrismaVectorStore<
...
> extends VectorStore {
  ...
  static withModel<TModel extends Record<string, unknown>>(
    ...
    >(
      ...
      TModel,
      keyof TPrisma["ModelName"] & string,
      TColumns,
      TFilters
    >;
    fromTexts: <
    ...
    >(
      ...
      PrismaVectorStore<
        TModel,
        keyof TPrisma_2["ModelName"] & string,
        TColumns_2,
        TFilters_1
      >
    >;
  ...
  similaritySearch(
    query: string,
    k?: number,
    _filter?: this["FilterType"] | undefined, // not used. here to make the interface compatible with the other stores
