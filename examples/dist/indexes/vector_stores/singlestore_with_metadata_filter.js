...
export const run = async () => {
    const vectorStore = await SingleStoreVectorStore.fromTexts(["Good afternoon", "Bye bye", "Boa tarde!", "Até logo!"], [
...
//# sourceMappingURL=singlestore_with_metadata_filter.js.map