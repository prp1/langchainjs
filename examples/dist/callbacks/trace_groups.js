import { traceAsGroup, TraceGroup } from "langchain/callbacks";
...
export const run = async () => {
    ...
    const blockResult = await traceAsGroup({ name: "my_group_name" }, async (manager, questions) => {
    ...
    try {
        ...
        await chain.call({ question: "What is the airspeed velocity of an unladen swallow?" }, groupManager);
    }
    finally {
        // Code goes here
...
//# sourceMappingURL=trace_groups.js.map